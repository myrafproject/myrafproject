    ...
    def setzscale(self, z1='auto', z2='auto', nsig=3,
        ...
        if (z1 == 'auto' or z2 == 'auto' or
            ...
            if z1 == 'auto':
                ...
                nearskypixvals = statsel[
                    np.logical_and(statsel > medianlevel - 2 * firststd, statsel < medianlevel + 2 * firststd)]
            ...
            if z1 == 'flat':
                ...
                nearflatpixvals = statsel[
                    np.logical_and(statsel > medianlevel - 5 * firststd, statsel < medianlevel + 5 * firststd)]

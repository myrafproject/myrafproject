...
Usage:
    import pysex
    cat = pysex.run(myimage,
                    params=['X_IMAGE', 'Y_IMAGE', 'FLUX_APER'],
...
def run(image='', imageref='', params=[], conf_file=None,
    ...
    conf_args: optional, list of arguments to be passed to sextractor
               (overrides the parameters in the conf file)
